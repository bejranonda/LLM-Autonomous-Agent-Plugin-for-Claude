...
class UnifiedParameterStorage:
    ...
    def _read_data(self, use_cache: bool = True):
    ...
    def get_quality_history(self, days: int = 30):
    ...
    def get_model_performance(self, model: str):
    ...
    # Migration methods
    def migrate_from_legacy_storage(self, force: bool = False):
    ...
    def import_data(self, import_path: str, merge_strategy: str = "merge"):
