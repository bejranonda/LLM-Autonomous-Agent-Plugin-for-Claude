...
python ${CLAUDE_PLUGIN_ROOT}/lib/user_preference_memory.py --export old_prefs.json

# Import to new system
python ${CLAUDE_PLUGIN_ROOT}/lib/user_preference_memory.py --import old_prefs.json --strategy merge
```
