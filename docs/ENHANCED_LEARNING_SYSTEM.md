...
```bash
# CLI usage
python ${CLAUDE_PLUGIN_ROOT}/lib/predictive_skills.py predict --context '{
...
```bash
# CLI usage
python ${CLAUDE_PLUGIN_ROOT}/lib/enhanced_learning.py capture --pattern '{
  "task_type": "refactoring",
  "complexity": "medium",
...
4. Retrain models: `python ${CLAUDE_PLUGIN_ROOT}/lib/predictive_skills.py update`
